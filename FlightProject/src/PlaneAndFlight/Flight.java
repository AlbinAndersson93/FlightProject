...
public class Flight {
	...
	public static void printFlights(){
		...
		while(itFlight.hasNext()){
			...
			System.out.println("Flight #" +key+" || from "+Init.getFlightList().get(key).getSource() + " to " + Init.getFlightList().get(key).getDestination()+" flought by "+Init.getFlightList().get(key).getPlane().getName()+" at "+Init.getFlightList().get(key).getDepartureTime());
